...
_global.$addTween = function (mtarget, prop, propDest, timeSeconds, animType, delay, callback, extra1, extra2, extras)
{
    ...
    else
    {
        ...
        _loc11 = [];
        _loc9 = [];
        for (var _loc30 in prop)
        {
            _loc11.push(mtarget[prop[_loc30]]);
        } // end of for...in
        for (var _loc30 in prop)
        {
            _loc7.push(prop[_loc30]);
        } // end of for...in
        for (var _loc30 in propDest)
        {
            _loc9.push(propDest[_loc30]);
        } // end of for...in
    } // end else if
    var _loc12 = false;
    ...
    var _loc5 = _root.__tweenController__.$_tweenPropList;
    var _loc8 = _root.__tweenController__.$_tTime;
    for (var _loc30 in _loc11)
    {
        if (_loc9[_loc30] != undefined && !mtarget.$_isTweenLocked)
        {
            if (mtarget.$_tweenCount > 0)
            {
                for (var _loc3 = 0; _loc3 < _loc5.length; ++_loc3)
                {
                    if (_loc5[_loc3]._targ == mtarget && _loc5[_loc3]._prop == _loc7[_loc30])
                    {
                        if (_loc8 + delay * 1000 < _loc5[_loc3]._timeDest)
                        {
                            _loc5.splice(_loc3, 1);
                            --_loc3;
                            --mtarget.$_tweenCount;
                        } // end if
                    } // end if
            ...
            _loc5.push({_prop: _loc7[_loc30], _targ: mtarget, _propStart: undefined, _propDest: _loc9[_loc30], _timeStart: _loc8, _timeDest: _loc8 + timeSeconds * 1000, _animType: animType, _extra1: extra1, _extra2: extra2, _extras: extras, _delay: delay, _isPaused: false, _timePaused: 0, _callback: _loc12 ? (undefined) : (callback)});
...
_global.$updateTweens = function ()
{
    ...
    for (var _loc7 = 0; _loc7 < this.$_tweenPropList.length; ++_loc7)
    {
        var _loc3 = this.$_tweenPropList[_loc7];
        if (_loc3._targ.toString() == undefined)
        {
            this.$_tweenPropList.splice(_loc7, 1);
            --_loc7;
            continue;
        } // end if
        if (_loc3._timeStart + _loc3._delay * 1000 <= _loc8 && !_loc3._isPaused)
        {
            ...
            var _loc11 = _loc3._timeDest + _loc3._delay * 1000;
            if (_loc11 <= _loc8)
            {
            ...
            if (_loc3._prop == "__special_bst_t__")
            {
                ...
                var _loc9 = _global.findPointOnCurve(_loc6.__special_bst_ix__, _loc6.__special_bst_iy__, _loc6.__special_bst_cx__, _loc6.__special_bst_cy__, _loc6.__special_bst_dx__, _loc6.__special_bst_dy__, _loc4);
...
_global.$setFilterProperty = function (mtarget, propName, propValue, extras)
{
    ...
    var _loc7 = false;
    var _loc2 = [];
    for (var _loc3 = 0; _loc3 < mtarget.filters.length; ++_loc3)
    {
        _loc2.push(mtarget.filters[_loc3]);
    } // end of for
    if (propName.substr(0, 5) == "blur_")
    {
        for (var _loc3 = 0; _loc3 < mtarget.filters.length; ++_loc3)
        {
            if (_loc2[_loc3] instanceof flash.filters.BlurFilter)
            {
                _loc2[_loc3][propName.substr(5)] = propValue;
                if (extras.__special_blur_quality__ != undefined)
                {
                    _loc2[_loc3].quality = extras.__special_blur_quality__;
                } // end if
                _loc7 = true;
                break;
            } // end if
        ...
        {
            var _loc8;
            var _loc9 = extras.__special_blur_quality__ == undefined ? (2) : (extras.__special_blur_quality__);
            if (propName == "blur_blurX")
            {
                _loc8 = new flash.filters.BlurFilter(propValue, 0, _loc9);
            } // end if
            if (propName == "blur_blurY")
            {
                _loc8 = new flash.filters.BlurFilter(0, propValue, _loc9);
            } // end if
            _loc2.push(_loc8);
        } // end if
    }
    else if (propName.substr(0, 5) == "glow_")
    {
        for (var _loc3 = 0; _loc3 < mtarget.filters.length; ++_loc3)
        {
            if (_loc2[_loc3] instanceof flash.filters.GlowFilter)
            {
                _loc2[_loc3][propName.substr(5)] = propValue;
                if (extras.__special_glow_quality__ != undefined)
                {
                    _loc2[_loc3].quality = extras.__special_glow_quality__;
                } // end if
                if (extras.__special_glow_inner__ != undefined)
                {
                    _loc2[_loc3].inner = extras.__special_glow_inner__;
                } // end if
                if (extras.__special_glow_knockout__ != undefined)
                {
                    _loc2[_loc3].knockout = extras.__special_glow_knockout__;
                } // end if
                _loc7 = true;
                break;
            } // end if
        ...
        if (!_loc7)
        {
            _loc9 = extras.__special_glow_quality__ == undefined ? (2) : (extras.__special_glow_quality__);
            ...
            {
                _loc8 = new flash.filters.GlowFilter(propValue, 1, 0, 0, 1, _loc9, _loc12, _loc10);
            } // end if
            if (propName == "glow_alpha")
            {
                _loc8 = new flash.filters.GlowFilter(16777215, propValue, 0, 0, 1, _loc9, _loc12, _loc10);
            } // end if
            if (propName == "glow_blurX")
            {
                _loc8 = new flash.filters.GlowFilter(16777215, 1, propValue, 0, 1, _loc9, _loc12, _loc10);
            } // end if
            if (propName == "glow_blurY")
            {
                _loc8 = new flash.filters.GlowFilter(16777215, 1, 0, propValue, 1, _loc9, _loc12, _loc10);
            } // end if
            if (propName == "glow_strength")
            {
                _loc8 = new flash.filters.GlowFilter(16777215, 1, 0, 0, propValue, _loc9, _loc12, _loc10);
            } // end if
            _loc2.push(_loc8);
        } // end if
    }
    else if (propName.substr(0, 6) == "bevel_")
    {
        for (var _loc3 = 0; _loc3 < mtarget.filters.length; ++_loc3)
        {
            if (_loc2[_loc3] instanceof flash.filters.BevelFilter)
            {
                _loc2[_loc3][propName.substr(6)] = propValue;
                if (extras.__special_bevel_quality__ != undefined)
                {
                    _loc2[_loc3].quality = extras.__special_bevel_quality__;
                } // end if
                if (extras.__special_bevel_type__ != undefined)
                {
                    _loc2[_loc3].inner = extras.__special_bevel_type__;
                } // end if
                if (extras.__special_bevel_knockout__ != undefined)
                {
                    _loc2[_loc3].knockout = extras.__special_bevel_knockout__;
                } // end if
                _loc7 = true;
                break;
            } // end if
        ...
        if (!_loc7)
        {
            _loc9 = extras.__special_bevel_quality__ == undefined ? (2) : (extras.__special_bevel_quality__);
            ...
            {
                _loc8 = new flash.filters.BevelFilter(propValue, 45, 16777215, 1, 0, 1, 0, 0, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_angle")
            {
                _loc8 = new flash.filters.BevelFilter(0, propValue, 16777215, 1, 0, 1, 0, 0, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_highlightColor")
            {
                _loc8 = new flash.filters.BevelFilter(0, 45, propValue, 1, 0, 1, 0, 0, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_highlightAlpha")
            {
                _loc8 = new flash.filters.BevelFilter(0, 45, 16777215, propValue, 0, 1, 0, 0, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_shadowColor")
            {
                _loc8 = new flash.filters.BevelFilter(0, 45, 16777215, 1, propValue, 1, 0, 0, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_shadowAlpha")
            {
                _loc8 = new flash.filters.BevelFilter(0, 45, 16777215, 1, 0, propValue, 0, 0, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_blurX")
            {
                _loc8 = new flash.filters.BevelFilter(0, 45, 16777215, 1, 0, 1, propValue, 0, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_blurY")
            {
                _loc8 = new flash.filters.BevelFilter(0, 45, 16777215, 1, 0, 1, 0, propValue, 1, _loc9, _loc11, _loc10);
            } // end if
            if (propName == "bevel_strength")
            {
                _loc8 = new flash.filters.BevelFilter(0, 45, 16777215, 1, 0, 1, 0, 0, propValue, _loc9, _loc11, _loc10);
            } // end if
            _loc2.push(_loc8);
        } // end if
    }
...
MovieClip.prototype.colorTo = function (propDest_color, timeSeconds, animType, delay, callback, extra1, extra2)
{
    ...
    {
        var _loc5 = propDest_color >> 16;
        var _loc3 = (propDest_color & 65280) >> 8;
        var _loc4 = propDest_color & 255;
        this.colorTransformTo(0, _loc5, 0, _loc3, 0, _loc4, undefined, undefined, timeSeconds, animType, delay, callback, extra1, extra2);
    } // end else if
};
...
TextField.prototype.colorTo = function (propDest_color, timeSeconds, animType, delay, callback, extra1, extra2)
{
    ...
    var _loc3 = (propDest_color & 65280) >> 8;
    var _loc4 = propDest_color & 255;
    _global.$addTween(this, ["__special_text_r__", "__special_text_g__", "__special_text_b__"], [_loc5, _loc3, _loc4], timeSeconds, animType, delay, callback, extra1, extra2);
};
...
{
    var _loc6 = objProp._propStart >> 16;
    var _loc10 = objProp._propDest >> 16;
    var _loc9 = objProp._propStart >> 8 & 255;
    var _loc8 = objProp._propDest >> 8 & 255;
    var _loc4 = objProp._propStart & 255;
    var _loc7 = objProp._propDest & 255;
    var _loc3 = Math.round(_global.findTweenValue(_loc6, _loc10, objProp._timeStart, tTime - objProp._delay * 1000, objProp._timeDest, objProp._animType, objProp._extra1, objProp._extra2));
    var _loc5 = Math.round(_global.findTweenValue(_loc9, _loc8, objProp._timeStart, tTime - objProp._delay * 1000, objProp._timeDest, objProp._animType, objProp._extra1, objProp._extra2));
    var _loc11 = Math.round(_global.findTweenValue(_loc4, _loc7, objProp._timeStart, tTime - objProp._delay * 1000, objProp._timeDest, objProp._animType, objProp._extra1, objProp._extra2));
    return ((_loc3 << 16) + (_loc5 << 8) + _loc11);
};
_global.findTweenValue = function (_propStart, _propDest, _timeStart, _timeNow, _timeDest, _animType, _extra1, _extra2)
{
    ...
    switch (_animType.toLowerCase())
    {
        ...
        case "easeinelastic":
        {
            ...
            if (!_loc6)
            {
                _loc6 = _loc3 * 0.300000;
            } // end if
            if (!_loc7 || _loc7 < Math.abs(_loc2))
            {
                _loc7 = _loc2;
                _loc5 = _loc6 / 4;
            }
            ...
            {
                _loc5 = _loc6 / 6.283185 * Math.asin(_loc2 / _loc7);
            } // end else if
            _loc1 = _loc1 - 1;
            return (-_loc7 * Math.pow(2, 10 * _loc1) * Math.sin((_loc1 * _loc3 - _loc5) * 6.283185 / _loc6) + _loc4);
        } 
        case "easeoutelastic":
        {
            if (_loc1 == 0)
            ...
            return (_loc7 * Math.pow(2, -10 * _loc1) * Math.sin((_loc1 * _loc3 - _loc5) * 6.283185 / _loc6) + _loc2 + _loc4);
        } 
        case "easeinoutelastic":
        {
            ...
            {
                _loc1 = _loc1 - 1;
                return (-0.500000 * (_loc7 * Math.pow(2, 10 * _loc1) * Math.sin((_loc1 * _loc3 - _loc5) * 6.283185 / _loc6)) + _loc4);
            } // end if
            _loc1 = _loc1 - 1;
            return (_loc7 * Math.pow(2, -10 * _loc1) * Math.sin((_loc1 * _loc3 - _loc5) * 6.283185 / _loc6) * 0.500000 + _loc2 + _loc4);
        } 
...
_root.onEnterFrame = function ()
{
    if (preloader < 100)
    {
        ...
        {
            loader["dotUp" + i].xSlideTo(Math.round(preloader) * 2 - 3, 0.700000, "easeoutexpo");
            loader["dotUp" + i].ySlideTo(-1, 0.700000, "easeoutexpo");
            loader["dotDw" + i].xSlideTo(200 - Math.round(preloader) * 2 + 1, 0.700000, "easeoutexpo");
            loader["dotDw" + i].ySlideTo(1, 0.700000, "easeoutexpo");
        } // end of for
        loaded = preloader;
        preloader = preloader + 0.600000;
    }
    else
    {
        gotoAndStop("home");
